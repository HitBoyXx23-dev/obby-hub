...
local checkpoints = Utils.createCheckpointManager({ max = 15 })
...
local function updateCheckpointUI()
    ...
    cpLabel.Text = "CHECKPOINTS  " .. tostring(checkpoints:count()) .. "/15"
...
local clearBtn = UI.createButton(right, "CLEAR ALL", UDim2.new(1, 0, 0, 22), UDim2.new(0, 0, 0, 76))
...
UI.createSectionLabel(right, "MOVEMENT", 108)

local flyBtn, flyStroke = UI.createButton(right, "FLY: OFF", UDim2.new(1, 0, 0, 26), UDim2.new(0, 0, 0, 124))
...
speedLabel.Position = UDim2.new(0, 0, 0, 154)
...
speedFrame.Position = UDim2.new(0, 0, 0, 168)
...
walkLabel.Position = UDim2.new(0, 0, 0, 200)
...
walkFrame.Position = UDim2.new(0, 0, 0, 214)
...
UI.createSectionLabel(right, "AUTO-ASSIST", 248)

local perfectParkourBtn, perfectParkourStroke = UI.createButton(right, "PERFECT PARKOUR: OFF", UDim2.new(1, 0, 0, 26), UDim2.new(0, 0, 0, 264))
local noFallBtn, noFallStroke = UI.createButton(right, "NO FALL: OFF", UDim2.new(1, 0, 0, 26), UDim2.new(0, 0, 0, 294))
local invBtn, invStroke = UI.createButton(right, "INVINCIBLE: OFF", UDim2.new(1, 0, 0, 26), UDim2.new(0, 0, 0, 324))
local clickTPBtn, clickTPStroke = UI.createButton(right, "CLICK TELEPORT: OFF", UDim2.new(1, 0, 0, 26), UDim2.new(0, 0, 0, 354))
...
clickTPBtn.MouseButton1Click:Connect(function()
    ...
    if state.clickTP then
        window.notify("Click anywhere to teleport")
    end
end)
